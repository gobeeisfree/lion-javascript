    ...
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
      ...
      <g>
        <animateTransform attributeName="transform" type="rotate" values="360 50 50;0 50 50" keyTimes="0;1" dur="1s"
          repeatCount="indefinite" calcMode="spline" keySplines="0.5 0 0.5 1" begin="-0s"></animateTransform>
        <circle cx="50" cy="50" r="39.891" stroke="#8cc63f" stroke-width="14.4" fill="none"
          stroke-dasharray="0 300">
          <animate attributeName="stroke-dasharray" values="15 300;0 300;15 300" keyTimes="0;0.5;1" dur="1s"
            repeatCount="indefinite" calcMode="linear" keySplines="0 0.4 0.6 1;0.4 0 1 0.6" begin="-0s"></animate>
        </circle>
      ...
      <g>
        ...
        <path fill="#009245" stroke="#000000"
        ...
        <path fill="#8cc63f" stroke="#000000"
          d="M97.2,50c0,6.1-1.2,12.2-3.5,17.8l-13.3-5.4c1.6-3.9,2.4-8.2,2.4-12.4"></path>
        <path fill="#fff794" transform="translate(0,-0.2)"
      ...
      <g>
        ...
        <path fill="#8cc63f" stroke="#000000" transform="translate(0,0.2)"
        ...
        <path fill="#fff794" transform="translate(0,0.3)"
        ...
        <path fill="#fceca6" stroke="#000000"
